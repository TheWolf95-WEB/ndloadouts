/* ==========================================================
   ...
   Автор: Равиль-прошибатель кнопок 😎 (ну и я помог)
   Требования из ТЗ: iOS/Android/Desktop WebView, без либ,
   только от левого края (<= 40px), не мешает вертикальному
   скроллу, плавная анимация, вибра/хаптика, velocity > 0.3,
   не срабатывает на #screen-home, совместим с обычным браузером.
